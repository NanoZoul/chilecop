	        ...
	        <div class="col-md-10 col-sm-11 display-table-cell valign-top">
	          ...
	          <div id="content">
	            <header class="clearfix">
	              <div class="col-xs-5 col-sm-3 col-md-3"><b>Empresas Mandantes</b></div>
	              <div class="col-xs-7 col-sm-9 col-md-9">
	              	<a class="btn btn-xs btn-success pull-right" href="ingresarMandante.php" role="button">Ingresar Empresa</a>	
	              </div>
	            </header>
