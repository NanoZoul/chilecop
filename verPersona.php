...
<html lang="en">
  <head>
    ...
    list($estado,$rut,$nombres,$apellidos,$cargo,$f_nacimiento,$procedencia,$alergias,$fono_emergencia,$direccion) = explode("%$", $contenido);
    switch ($estado) {
      case '1':
        $estadoClass = "ok";
        $estadoTxt = "Aprobado";
          ...
          <div id="content">
            <header class="clearfix">
              ...
              <div class="col-xs-7 col-sm-9 col-md-9">
                <a style="margin-left:1em; margin-bottom:0.5em;" class='btn btn-xs btn-warning pull-right' href='editarPersona.php?id=<?php echo $id; ?>' role='button'>Editar</a>  
